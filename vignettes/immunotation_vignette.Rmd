...
different species
* conversion between different levels of HLA annotation, conversion between input and output of different immunoinformatics 
tools
* mapping between allele notation and G and P groups
